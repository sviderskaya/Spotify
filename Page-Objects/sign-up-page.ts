...
export class SightUpPage extends MainPage{
    ...
    readonly manRadioBtn: Locator = this.page.locator('#gender_option_male');
    readonly womanRadioBtn: Locator = this.page.locator('#gender_option_female');
    readonly nonBinaryRadioBtn: Locator = this.page.locator('#gender_option_non_binary');
    readonly somethingElseRadioBtn: Locator = this.page.locator('#gender_option_other');
    readonly preferNotToSayRadioBtn: Locator = this.page.locator('#gender_option_prefer_not_to_say');

    readonly marketingCheckbox: Locator = this.page.locator('#checkbox-marketing');
    readonly privacyCheckbox: Locator = this.page.locator('#checkbox-privacy');
    readonly termsAndConditionsCheckbox: Locator = this.page.locator('#terms-conditions-checkbox');
    ...
    async userRegistration(): Promise<void> {
        ...
        await this.emailAddressInput.fill(faker.internet.email({ firstName: 'test'}));
        ...
        await this.yearInput.fill(faker.date.birthdate({ min: 1950, max: 2015, mode: 'year' }).getFullYear().toString());
        await this.monthDropdown.click();
        await this.monthDropdown.getByText('January').click();
